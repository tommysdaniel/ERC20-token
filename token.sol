...
contract Token is ERC20, Lockable {
    ...
    */
    function transfer(address _to, uint256 _value) unlocked returns (bool success) {
    ...
    */
    function transferFrom(address _from, address _to, uint256 _value) unlocked returns (bool) {
